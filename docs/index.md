...
| [legal.md](./legal.md) | Юр. комплаенс, согласия, версии документов |
| [privacy_policy.md](./privacy_policy.md) | Политика конфиденциальности (публичный текст) |
| [public_offer.md](./public_offer.md) | Публичная оферта (публичный текст) |
