...
(v1.4 → v1.5: фотоучёт в photo_usage, код 402 limit_reached)
1. Цели тестирования
...
Postman collection v1.5 + CI:• Проверка кодов 200/400/401/402/502• Ajv‑валидация схем OpenAPI• Проверка quota: /limits → 5/5 → diagnose = 402
9. Security checks
